...
function weixin(e, i) {
    n.post({
            ...
            e.commit("_loginCallback", o({
                json: t
            }, i)),
            0 !== t.base_resp.ret && e.dispatch("verifyImgRefresh", {
                account: i.account,
                rand: i.rand
            })
        }
        : function (t) {
            0 === t.grey ? ((new Image).src = "/mp/jsmonitor?idkey=66811_4_1",
                e.dispatch("_loginPost", o({
                    isOld: !0,
                    url: "/cgi-bin/login?loginhook=4"
                }, i))) : (e.commit("_loginCallback", o({
                json: t
            }, i)),
            0 !== t.base_resp.ret && e.dispatch("verifyImgRefresh", {
                account: i.account,
